...
function displayPics() {
  ...
  //Answer: The above line of code threw an error because it's trying to console log a variable that was declared using 'let' in a code block, so the 'rando' variable can only be seen in the corresponding code block which is the first while loop inside the function 'displayPics'.
  // So even if the console.log is inside the 'diplayPics function, the 'let' declaration works inside the same code block which is 'while(viewed.length<6)'
  console.log(viewed);
